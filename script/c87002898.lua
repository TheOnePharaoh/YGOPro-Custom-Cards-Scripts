...
function c87002898.initial_effect(c)
	...
	e6:SetCondition(c87002898.uncon)
	...
	e7:SetValue(500)
	e7:SetCondition(c87002898.uncon)
	c:RegisterEffect(e7)
	--Def up
	...
	e9:SetCondition(c87002898.uncon)
	e9:SetValue(1)
	c:RegisterEffect(e9)
	--eqlimit
...
function c87002898.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c87002898.filter(chkc) end

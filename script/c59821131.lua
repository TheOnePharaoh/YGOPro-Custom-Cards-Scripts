...
function c59821131.adval(e,tp,eg,ep,ev,re,r,rp)
	...
	if a:GetCounter(0x107)>0 and d:IsSetCard(0xa1a2) then c59821131.addown(a,e) end
	if d:GetCounter(0x107)>0 and a:IsSetCard(0xa1a2) then c59821131.addown(d,e) end
end

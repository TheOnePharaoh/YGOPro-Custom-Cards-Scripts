...
function c55438802.initial_effect(c)
	...
	e5:SetCondition(c55438802.dircon)
	c:RegisterEffect(e5)
	local e6=e5:Clone()
	e6:SetCode(EFFECT_CANNOT_ATTACK)
	e6:SetCondition(c55438802.atkcon)
	c:RegisterEffect(e6)
	--draw
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(55438802,1))
	e7:SetCategory(CATEGORY_TOGRAVE+CATEGORY_RECOVER)
	e7:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e7:SetCode(EVENT_REMOVE)
	e7:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DELAY)
	e7:SetCountLimit(1,55438802)
	e7:SetTarget(c55438802.tgtg)
	e7:SetOperation(c55438802.tgop)
	c:RegisterEffect(e7)
end
function c55438802.dircon(e)
	return e:GetHandler():GetAttackAnnouncedCount()>0
end
function c55438802.atkcon(e)

...
function c90000060.initial_effect(c)
	...
	e1:SetCondition(c90000060.condition)
	...
	e2:SetCondition(c90000060.condition)
...
function c90000060.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c90000060.filter,tp,LOCATION_ONFIELD,0,1,nil) and Duel.GetLP(tp)<=1000
end

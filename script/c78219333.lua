...
function c78219333.filter(c)
	return c:IsFaceup() and not c:IsCode(78219333) and c:IsCanAddCounter(0x1108,2)
end
function c78219333.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SetOperationInfo(0,CATEGORY_COUNTER,nil,2,0,0x1108)
end
...
function c78219333.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsFaceup() and tc:IsRelateToEffect(e) and tc:AddCounter(0x1108,2) then

...
function c100000840.cfilter(c)
	return c:IsSetCard(0x10B) and c:IsAbleToDeckAsCost() and not c:IsCode(100000840)
end
...
function c100000840.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE+LOCATION_DECK) and c100000840.filter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c100000840.filter,tp,LOCATION_GRAVE+LOCATION_DECK,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectTarget(tp,c100000840.filter,tp,LOCATION_GRAVE+LOCATION_DECK,0,1,1,nil)

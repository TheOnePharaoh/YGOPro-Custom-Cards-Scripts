...
function c100000864.initial_effect(c)
	...
	e4:SetCondition(c100000864.descon)
...
function c100000864.coffilter(c)
	return c:IsFaceup() and c:IsSetCard(0x10E) and c:IsType(TYPE_MONSTER)
end
function c100000864.descon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c100000864.coffilter,tp,LOCATION_MZONE,0,1,e:GetHandler())
end
...
function c100000864.filter(c)
	return c:IsSetCard(0x10E) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(100000864)
end

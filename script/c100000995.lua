...
function c100000995.filter(c)
	...
	return (code==00691925 or code==94886282 or code==52665542 or code==30502181 or code==36099620 or code==66194206 or code==22201234 or code==35577420 or code==61962135 or code==32233746) and c:IsAbleToHand() and not c:IsHasEffect(EFFECT_NECRO_VALLEY)
end
function c100000995.target(e,tp,eg,ep,ev,re,r,rp,chk)

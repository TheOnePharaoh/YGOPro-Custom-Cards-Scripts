--Lightning Road
function c512000077.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c512000077.target)
	e1:SetOperation(c512000077.activate)
	c:RegisterEffect(e1)
end
function c512000077.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c512000077.activate(e,tp,eg,ep,ev,re,r,rp)

...
function c20161997.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(20161997,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCode(EVENT_TO_DECK)
	e2:SetCountLimit(1)
	e2:SetCondition(c20161997.condition)
	e2:SetTarget(c20161997.sptg2)
	e2:SetOperation(c20161997.spop2)
	c:RegisterEffect(e2)
end
function c20161997.spfilter1(c,e,tp)
	return c:IsRace(RACE_REPTILE) and not c:IsCode(20162003) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c20161997.condition(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(r,REASON_EFFECT)~=0 and eg:IsExists(c20161997.cfilter,1,nil,tp)
end

...
function c544454451.initial_effect(c)
	...
	e3:SetTarget(c544454451.destarget)
	c:RegisterEffect(e3)
end
...
function c544454451.spcon(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c544454451.spfilter,c:GetControler(),LOCATION_DECK,0,1,nil)
end
function c544454451.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local tc=Duel.GetFirstMatchingCard(c544454451.spfilter,tp,LOCATION_DECK,0,nil)
...
function c544454451.destarget(e,c)

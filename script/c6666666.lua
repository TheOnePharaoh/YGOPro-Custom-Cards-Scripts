...
function c6666666.initial_effect(c)
	...
	e8:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x900))
	e8:SetValue(1)
	e8:SetCondition(c6666666.indes2co)
	c:RegisterEffect(e8)
end
...
function c6666666.tgcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetCounter(0x104)>=7
end
function c6666666.indes2co(e,tp,eg,ep,ev,re,r,rp)

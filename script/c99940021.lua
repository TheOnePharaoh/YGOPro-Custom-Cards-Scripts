--NGNL - Shiro
function c99940021.initial_effect(c)
  aux.EnablePendulumAttribute(c)
  --Scale change
  local e2=Effect.CreateEffect(c)
  e2:SetDescription(aux.Stringid(99940021,0))
  e2:SetType(EFFECT_TYPE_IGNITION)
  e2:SetRange(LOCATION_PZONE)
  e2:SetCountLimit(1)
  e2:SetOperation(c99940021.scop)
  c:RegisterEffect(e2)
  ...
  e3:SetCountLimit(1)
  e3:SetCondition(c99940021.tgcon)
  e3:SetTarget(c99940021.tgtg)
  e3:SetOperation(c99940021.tgop)
  c:RegisterEffect(e3)
  ...
  e4:SetCondition(c99940021.thcon)
  e4:SetTarget(c99940021.thtg)
  e4:SetOperation(c99940021.thop)
  c:RegisterEffect(e4)
  ...
  e5:SetCondition(c99940021.thcon2)
  e5:SetTarget(c99940021.thtg2)
  e5:SetOperation(c99940021.thop2)
  c:RegisterEffect(e5)
  ...
  e6:SetOperation(c99940021.atkop)
  c:RegisterEffect(e6)
end
function c99940021.scop(e,tp,eg,ep,ev,re,r,rp)
...
function c99940021.tgcon(e,tp,eg,ep,ev,re,r,rp)
  return Duel.GetTurnPlayer()==tp
end
function c99940021.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
  if chk==0 then return true end
  Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,0,1,tp,LOCATION_DECK)
  Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,nil,1,1-tp,LOCATION_DECK)
end
function c99940021.tgop(e,tp,eg,ep,ev,re,r,rp)
...
function c99940021.thfilter(c,tp)
  return c:GetSummonPlayer()~=tp
end
function c99940021.thcon(e,tp,eg,ep,ev,re,r,rp)
  return eg:IsExists(c99940021.thfilter,1,nil,tp)
end
function c99940021.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
  if chk==0 then return Duel.IsExistingMatchingCard(Card.IsAbleToHand,tp,0,LOCATION_DECK,1,nil) end
  Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,0,0)
end
function c99940021.thop(e,tp,eg,ep,ev,re,r,rp)
  local g=Duel.GetDecktopGroup(1-tp,1)
  local tc=g:GetFirst()
  Duel.SendtoHand(tc,tp,REASON_EFFECT)
end
function c99940021.thcon2(e,tp,eg,ep,ev,re,r,rp)
  return ep~=tp and Duel.GetCurrentPhase()~=PHASE_DRAW
end
function c99940021.thtg2(e,tp,eg,ep,ev,re,r,rp,chk)
  if chk==0 then return Duel.IsExistingMatchingCard(Card.IsAbleToHand,tp,0,LOCATION_HAND,1,nil) end
  Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,0,0)
end
function c99940021.thop2(e,tp,eg,ep,ev,re,r,rp)
...
function c99940021.atkop(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()   
  local e1=Effect.CreateEffect(c)
  e1:SetType(EFFECT_TYPE_SINGLE)

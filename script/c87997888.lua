...
function c87997888.initial_effect(c)
	...
	e2:SetCondition(c87997888.excon)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e4:SetTarget(c87997888.sumlimit)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e8:SetTarget(c87997888.destarget)
	c:RegisterEffect(e8)
	--cannot announce
	local e8=Effect.CreateEffect(c)
	e8:SetType(EFFECT_TYPE_FIELD)
...
function c87997888.sumlimit(e,c)
	return c:IsSetCard(0x23)
end
function c87997888.exfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x23)
end
function c87997888.excon(e)
	return Duel.IsExistingMatchingCard(c87997888.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil)
end
...
function c87997888.spcon(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		...
		and not Duel.IsExistingMatchingCard(c87997888.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil)
end
...
function c87997888.destarget(e,c)
...
function c87997888.atkfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x23) and c:GetCode()~=87997888
end
function c87997888.atkup(e,c)
	return Duel.GetMatchingGroupCount(c87997888.atkfilter,c:GetControler(),LOCATION_HAND,0,nil)*500
end

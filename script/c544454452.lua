...
function c544454452.initial_effect(c)
	...
	e2:SetCondition(c544454452.excon)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e4:SetTarget(c544454452.sumlimit)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e8:SetTarget(c544454452.destarget)
	c:RegisterEffect(e8)
	--cannot announce
	local e8=Effect.CreateEffect(c)
	e8:SetType(EFFECT_TYPE_FIELD)
...
function c544454452.exfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x23)
end
function c544454452.excon(e)
	return Duel.IsExistingMatchingCard(c544454452.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil)
end
...
function c544454452.spcon(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		...
		and not Duel.IsExistingMatchingCard(c544454452.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil)
end
...
function c544454452.destarget(e,c)

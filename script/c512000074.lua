--Defense Buster
function c512000074.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c512000074.target)
	e1:SetOperation(c512000074.activate)
	c:RegisterEffect(e1)
end
function c512000074.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c512000074.activate(e,tp,eg,ep,ev,re,r,rp)

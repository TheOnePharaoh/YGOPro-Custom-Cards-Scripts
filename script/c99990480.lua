...
function c99990480.initial_effect(c)
	...
	e1:SetCondition(c99990480.condition)
	e1:SetValue(500)
	c:RegisterEffect(e1)
	--Draw
	...
	e2:SetTarget(c99990480.drtg)
	e2:SetOperation(c99990480.drop)
	c:RegisterEffect(e2)
	--ATK/DEF
	...
	e4:SetCondition(c99990480.atkcon2)
	e4:SetOperation(c99990480.atkop)
	c:RegisterEffect(e4)
	...
	e5:SetCondition(c99990480.atkcon3)
	e5:SetOperation(c99990480.atkop)
	c:RegisterEffect(e5)
end
function c99990480.filter1(c)
	return c:IsFaceup() and c:IsSetCard(9999) and c:IsType(TYPE_MONSTER)
end
function c99990480.condition(e,c)
    local c=e:GetHandler()
	return Duel.IsExistingMatchingCard(c99990480.filter1,c:GetControler(),LOCATION_MZONE,0,2,nil)
end
function c99990480.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetTargetPlayer(tp)
	Duel.SetTargetParam(1)
	Duel.SetOperationInfo(0,CATEGORY_DRAW,nil,0,tp,1)
end
function c99990480.drop(e,tp,eg,ep,ev,re,r,rp)
...
function c99990480.atkcon2(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	local bc=tc:GetBattleTarget()
...
function c99990480.atkcon3(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	local bc=tc:GetBattleTarget()
	if tc==nil then return false

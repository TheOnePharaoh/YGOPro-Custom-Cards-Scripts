...
function c100000806.filter(c)
	return c:IsSetCard(0x109) and not c:IsType(TYPE_TUNER) and not c:IsCode(100000808) or c:IsCode(100000807) and c:IsAbleToHand() and not c:IsHasEffect(EFFECT_NECRO_VALLEY)
end

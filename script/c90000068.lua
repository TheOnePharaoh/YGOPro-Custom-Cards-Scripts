...
function c90000068.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c90000068.condition2)
	e3:SetCost(c90000068.cost)
	e3:SetTarget(c90000068.target2)
...
function c90000068.cost(e,tp,eg,ep,ev,re,r,rp,chk)

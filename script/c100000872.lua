...
function c100000872.spfilter(c)
	return c:IsSetCard(0x10E) and c:IsCanBeFusionMaterial() and c:IsAbleToGraveAsCost()
end
...
function c100000872.filterrgr(c)
	return  c:IsSetCard(0x10E) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemove()
end
...
function c100000872.filter(c)
	return c:IsSetCard(0x10E) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave() and not c:IsCode(100000872)
end

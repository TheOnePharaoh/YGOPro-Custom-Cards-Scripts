...
function c99990002.initial_effect(c)
	...
	e1:SetCondition(c99990002.spcon)
	c:RegisterEffect(e1)
	--Extra attack
	...
	e3:SetCondition(c99990002.atkcon)
	e3:SetOperation(c99990002.atkop)
	c:RegisterEffect(e3)
	...
	e4:SetCondition(c99990002.atkcon2)
	e4:SetOperation(c99990002.atkop)
	c:RegisterEffect(e4)
...
function c99990002.atkcon3(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
	local bc=tc:GetBattleTarget()
	if tc==nil then return false
...
function c99990002.atkop(e,tp,eg,ep,ev,re,r,rp)

...
function c57081280.initial_effect(c)
	...
	e3:SetValue(c57081280.tpval)
	c:RegisterEffect(e3)
	--special summon
	local e4=Effect.CreateEffect(c)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetDescription(aux.Stringid(57081280,0))
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCondition(aux.IsDualState)
	e4:SetTarget(c57081280.target)
	e4:SetOperation(c57081280.operation)
	c:RegisterEffect(e4)
end
function c57081280.tpval(e,c)

...
function c100000865.coffilter(c)
	return  c:IsSetCard(0x10E) and c:IsType(TYPE_SPELL+TYPE_TRAP) and not c:IsPublic()
end
function c100000865.mfilter(c)
	return  c:IsSetCard(0x10E) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function c100000865.filter(c)
	return  c:IsSetCard(0x10E) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand() and not c:IsCode(100000865)
end

...
function c4242568.dmfilter(c)
	return c:IsFaceup() and c:IsType(TYPE_PENDULUM) and c:IsSetCard(0x698)
end
...
function c4242568.filter2(c)
	return c:IsSetCard(0x698) and c:IsType(TYPE_PENDULUM) and c:IsLevelBelow(4) and not c:IsLevelBelow(3)
end

...
function c99930000.initial_effect(c)
  ...
  e4:SetCondition(c99930000.attcon)
  e4:SetTarget(c99930000.atttg)
  e4:SetOperation(c99930000.attop)
  c:RegisterEffect(e4)
...
function c99930000.attcon(e,tp,eg,ep,ev,re,r,rp)
  local c=e:GetHandler()
  local bc=c:GetBattleTarget()
  return c:IsRelateToBattle() and bc:IsType(TYPE_MONSTER) and not  bc:IsType(TYPE_TOKEN)
end
function c99930000.atttg(e,tp,eg,ep,ev,re,r,rp,chk)
  local bc=e:GetHandler():GetBattleTarget()
  if chk==0 then return true end
  Duel.SetTargetCard(bc)
end
function c99930000.attop(e,tp,eg,ep,ev,re,r,rp)
  local c=e:GetHandler() 

...
function c100000860.initial_effect(c)
	...
	e10:SetValue(c100000860.actset)
	e10:SetTargetRange(1,0)
	e10:SetTarget(aux.TRUE)
	c:RegisterEffect(e10)
	local e11=e10:Clone()
	e11:SetCode(EFFECT_CANNOT_SSET)
	e11:SetValue(c100000860.actset)
	c:RegisterEffect(e11)
	local e12=e10:Clone()
	e12:SetValue(c100000860.actset)
	e12:SetCode(EFFECT_CANNOT_TURN_SET)
	c:RegisterEffect(e12)
	local e13=e10:Clone()
	e13:SetValue(c100000860.actset)
	e13:SetCode(EFFECT_CANNOT_SPECIAL_SUMMON)
	e13:SetTarget(c100000860.sumlimit)
	...
	e14:SetTarget(c100000860.spslimit)
	...
	e15:SetTarget(c100000860.spslimit)
	c:RegisterEffect(e15)
end
function c100000860.spslimit(e,c)
	return not c:IsSetCard(0x10D)
end
function c100000860.sumlimit(e,c,sump,sumtype,sumpos,targetp)
	return bit.band(sumpos,POS_FACEDOWN)~=0
end
function c100000860.actset(e,re,tp)
	local rc=re:GetHandler()
	return not rc:IsSetCard(0x10D) and not rc:IsImmuneToEffect(e)
end
function c100000860.rfilter(c)
	return c:IsSetCard(0x10D) and c:IsType(TYPE_FIELD) and c:IsAbleToRemoveAsCost()
end
function c100000860.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c100000860.rfilter,tp,LOCATION_GRAVE,0,2,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c100000860.rfilter,tp,LOCATION_GRAVE,0,2,2,nil)

...
function c99990160.initial_effect(c)
  ...
  e1:SetOperation(c99990160.activate)
  c:RegisterEffect(e1)
  local e2=e1:Clone()
  ...
  e4:SetCondition(c99990160.atkcon)
  e4:SetOperation(c99990160.atkop)
  c:RegisterEffect(e4)
  ...
  e5:SetCondition(c99990160.atkcon2)
  e5:SetOperation(c99990160.atkop)
  c:RegisterEffect(e5)
  ...
  e6:SetCondition(c99990160.atkcon3)
  e6:SetOperation(c99990160.atkop)
  c:RegisterEffect(e6)  
end
function c99990160.filter1(c)
...
function c99990160.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
  if chkc then return chkc:IsOnField() and c99990160.filter1(chkc) and chkc~=e:GetHandler() end
  if chk==0 then return Duel.IsExistingTarget(c99990160.filter1,tp,0,LOCATION_ONFIELD,1,e:GetHandler()) end
  Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
  local g=Duel.SelectTarget(tp,c99990160.filter1,tp,0,LOCATION_ONFIELD,1,1,e:GetHandler())
  Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,1,0,0)
end
function c99990160.activate(e,tp,eg,ep,ev,re,r,rp)
...
function c99990160.atkcon2(e,tp,eg,ep,ev,re,r,rp)
  local tc=eg:GetFirst()
  local bc=tc:GetBattleTarget()
...
function c99990160.atkcon3(e,tp,eg,ep,ev,re,r,rp)
  local tc=eg:GetFirst()
  local bc=tc:GetBattleTarget()
  if tc==nil then return false

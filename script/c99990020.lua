...
function c99990020.initial_effect(c)
  ...
  e4:SetCondition(c99990020.atkcon2)
  e4:SetOperation(c99990020.atkop)
  c:RegisterEffect(e4)
  ...
  e5:SetCondition(c99990020.atkcon3)
  e5:SetOperation(c99990020.atkop)
  c:RegisterEffect(e5)
end
...
function c99990020.atkcon2(e,tp,eg,ep,ev,re,r,rp)
  local tc=eg:GetFirst()
  local bc=tc:GetBattleTarget()
...
function c99990020.atkcon3(e,tp,eg,ep,ev,re,r,rp)
  local tc=eg:GetFirst()
  local bc=tc:GetBattleTarget()
  if tc==nil then return false
